...
model CylinderGroundMeshOuterSlope "(Hollow) cylinder ground mesh with inclined outer surface"
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a innerPort[nElementsR] "inner port" annotation(
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_b slopePort[nElementsR] "Thermal port for 1-dim. heat transfer (unfilled rectangular icon)" annotation(
    Placement(transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 180), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  ...
  parameter Modelica.Units.SI.Temperature Tinitial[nElementsR];
  replaceable parameter Parameters.Soils.Soil groundData constrainedby MoSDH.Parameters.Soils.SoilPartial annotation(
     choicesAllMatching = true);
  GroundElement groundElements[nElements](each groundData = groundData, innerRadius(each fixed = true) = {meshR[elementCoordinates[iEl, 2]] for iEl in 1:nElements}, outerRadius(each fixed = true) = {meshR[elementCoordinates[iEl, 2] + 1] for iEl in 1:nElements}, elementHeight(each fixed = true) = {meshZ[elementCoordinates[iEl, 1] + 1] - meshZ[elementCoordinates[iEl, 1]] for iEl in 1:nElements}, Tinitial = {Tinitial[elementCoordinates[iEl, 1]] for iEl in 1:nElements}) "Vector of ground elements" annotation(
...
protected
  ...
  parameter Integer elementIndices[nElementsR, nElementsR] = MoSDH.Components.Storage.PitStorage.Functions.slopeElementIndice(isInnerSlope = false, nElementsR = nElementsR);
...
//bottom port connection
        if z < nElementsR then
          connect(groundElements[elementIndices[z, r]].bottomHeatPort, groundElements[elementIndices[z + 1, r]].topHeatPort) annotation(
            Line(points = 0));
        else
          connect(groundElements[elementIndices[z, r]].bottomHeatPort, bottomPort[r]) annotation(
            Line(points = {{0, -9.67}, {0, -4.7}, {40, -4.7}, {40, -96.7}, {0, -96.7}}, color = {191, 0, 0}, thickness = 0.0625));
        end if;
// connection to BCs
        if r == z then
          connect(groundElements[elementIndices[z, r]].outerHeatPort, slopePort[z]) annotation(
            Line(points = {{9.67, 0}, {74.7, 0}, {125, 0}, {125, 0}, {100, 0}}, color = {191, 0, 0}, thickness = 0.0625));
        end if;
// inner port connection (to left element)
        if r == 1 then
          connect(groundElements[elementIndices[z, r]].innerHeatPort, innerPort[z]) annotation(
            Line(points = {{-10, 0}, {40, 0}, {40, -8.88178e-16}, {-100, -8.88178e-16}}, color = {191, 0, 0}, thickness = 0.0625));
        else
          connect(groundElements[elementIndices[z, r]].innerHeatPort, groundElements[elementIndices[z, r - 1]].outerHeatPort);
        end if;
      end if;
    end for;
  end for;
  annotation(
    Icon(graphics = {Polygon(points = {{-100, -100}, {99.59999999999999, -100}, {-100, 100}}, fillColor = {210, 180, 140}, fillPattern = FillPattern.Solid), Bitmap(imageSource = "iVBORw0KGgoAAAANSUhEUgAAATwAAAEPCAYAAADf63gFAAAABGdBTUEAALGPC/xhBQAAAAlwSFlz
...
Kbsy5I8PuuDS8I1i6ExKKbu2mUe4ElIdSSllly6Bpz3t/wEy440VbTnrngAAAABJRU5ErkJggg==", extent = {{14.2, -102.9}, {84.7, -46.7}}), Bitmap(imageSource = "
...
Dzu/Kzt34EEIPRoKoUfjBB8dMeNDOpdylq80/85MhVpKtr3RTLUlx2fImxB05BCZFMIuzOw2FHYQ
XhxmeiH4fPgF6VzKNl5hcnLy35rc9YQbAeC3TU5nud98sZl6rRyvIWtCyPmgC2G3MCH0msHnw09K
Kbsy5I8PuuDS8I1i6ExKKbu2mUe4ElIdSSllly6Bpz3t/wEy440VbTnrngAAAABJRU5ErkJggg==", extent = {{-45.6, -103.1}, {24.9, -46.9}}), Bitmap(imageSource = "
...
Dzu/Kzt34EEIPRoKoUfjBB8dMeNDOpdylq80/85MhVpKtr3RTLUlx2fImxB05BCZFMIuzOw2FHYQ
XhxmeiH4fPgF6VzKNl5hcnLy35rc9YQbAeC3TU5nud98sZl6rRyvIWtCyPmgC2G3MCH0msHnw09K
Kbsy5I8PuuDS8I1i6ExKKbu2mUe4ElIdSSllly6Bpz3t/wEy440VbTnrngAAAABJRU5ErkJggg==", extent = {{-104.9, -102.8}, {-34.4, -46.6}}), Bitmap(imageSource = "
...
Dzu/Kzt34EEIPRoKoUfjBB8dMeNDOpdylq80/85MhVpKtr3RTLUlx2fImxB05BCZFMIuzOw2FHYQ
XhxmeiH4fPgF6VzKNl5hcnLy35rc9YQbAeC3TU5nud98sZl6rRyvIWtCyPmgC2G3MCH0msHnw09K
Kbsy5I8PuuDS8I1i6ExKKbu2mUe4ElIdSSllly6Bpz3t/wEy440VbTnrngAAAABJRU5ErkJggg==", extent = {{-44.2, -52.5}, {26.3, 3.7}}), Bitmap(imageSource = "
...
Dzu/Kzt34EEIPRoKoUfjBB8dMeNDOpdylq80/85MhVpKtr3RTLUlx2fImxB05BCZFMIuzOw2FHYQ
XhxmeiH4fPgF6VzKNl5hcnLy35rc9YQbAeC3TU5nud98sZl6rRyvIWtCyPmgC2G3MCH0msHnw09K
Kbsy5I8PuuDS8I1i6ExKKbu2mUe4ElIdSSllly6Bpz3t/wEy440VbTnrngAAAABJRU5ErkJggg==", extent = {{-104.5, -52.2}, {-34, 4}}), Bitmap(imageSource = "
...
Dzu/Kzt34EEIPRoKoUfjBB8dMeNDOpdylq80/85MhVpKtr3RTLUlx2fImxB05BCZFMIuzOw2FHYQ
XhxmeiH4fPgF6VzKNl5hcnLy35rc9YQbAeC3TU5nud98sZl6rRyvIWtCyPmgC2G3MCH0msHnw09K
Kbsy5I8PuuDS8I1i6ExKKbu2mUe4ElIdSSllly6Bpz3t/wEy440VbTnrngAAAABJRU5ErkJggg==", extent = {{-103.8, -0.9}, {-33.3, 55.3}})}),
    experiment(StopTime = 1, StartTime = 0, Tolerance = 1e-06, Interval = 0.001));
end CylinderGroundMeshOuterSlope;
